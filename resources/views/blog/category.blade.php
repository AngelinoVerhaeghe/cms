...
@section('content')
    ...
    <section class="background-image-2 flex items-center">
        <div class="grid grid-cols-1 text-center mx-auto">
            <div class="bg-white/20 backdrop-blur-md rounded-lg shadow-md p-4">
                <h1 class="text-gray-900 text-2xl md:text-4xl lg:text-6xl uppercase font-bold">{{ $category->name }}
                </h1>
                <h3 class="text-xl italic">Category</h3>
            </div>
        </div>
    </section>
    ...
    <section class="container mx-auto px-2 lg:px-0 my-15">
        ...
        <h2 class="text-3xl text-gray-700 md:text-center font-bold uppercase mb-5 md:mb-10 my-15">Category</h2>
