            ...
            <div class="bg-teal-100 rounded-lg shadow-md overflow-hidden p-6">
                ...
                <div class="-m-3 flex items-center">
                    @forelse ($categories as $category )
                        ...
                        @endif
                    @empty
                        <p class="text-left lg:text-center font-bold text-gray-700">There are no categories at this
                            moment...
                        </p>
                    @endforelse
                </div>
            ...
            <div class="bg-fuchsia-100 rounded-lg shadow-md overflow-hidden p-6">
                ...
                <div class="-m-3 flex flex-wrap items-center">
                    @forelse ($tags as $tag )
                        ...
                        @endif
                    @empty
                        <p class="text-left lg:text-center font-bold text-gray-700">There are no tags at this
                            moment...
                        </p>
                    @endforelse
                </div>
